    ...
    <body dir="rtl">
        <header>
            ...
            <div style="margin-right:300pt;">
                <b>التاريخ: </b> {{ $invoice->date->formatLocalized('%A %d %B %Y') }}<br />
                @if ($invoice->due_date)
                    <b>التاريخ: </b>{{ $invoice->due_date->formatLocalized('%A %d %B %Y') }}<br />
                @endif
                @if ($invoice->number)
                    <b>رقم#: </b> {{ $invoice->number }}
                @endif
                <br />
            </div>
            <br />
