...
class ReportController extends Controller
{
    ...
    public function getTrendingProducts(Request $request)
    {
        ...
        $chart = new Chart;//create('bar', 'highcharts')
            $chart->title(" ");
          //  $chart->dimensions(0, 400);
           // $chart->template("material");
            $chart->dataset(__('report.total_unit_sold'),'bar',$values);
            $chart->labels($labels);
       //  $chart->elementLabel(__('report.total_unit_sold'));
