...
// Then we can create a chart instance:
$borderColors = [
            "rgba(255, 99, 132, 1.0)",
            "rgba(22,160,133, 1.0)",
            "rgba(255, 205, 86, 1.0)",
...
$sells_chart_1 =new  Chart ;//create('line', 'chartjs')
    $sells_chart_1->title('My Chart');

     $sells_chart_1->labels($labels);
    
    //$chart->dataset('Users by trimester', 'bar', [10, 25, 13]);
     $sells_chart_1->dataset(__('report.all_locations'),'bar',$all_sell_values)->color($borderColors)->backgroundcolor($fillColors);
...
$sells_chart_2=new  Chart ;//create('line', 'chartjs')
    $sells_chart_2->title('المبيعات');

     $sells_chart_2->labels($labels);
    
    //$chart->dataset('Users by trimester', 'bar', [10, 25, 13]);
     $sells_chart_2->dataset(__('report.all_locations'),'line',$values)->color($borderColors)->backgroundcolor($fillColors);
